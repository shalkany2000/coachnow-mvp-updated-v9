...
export const mockCoaches: Coach[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 203,
    bio: 'Passionate about developing young athletes! With a background in youth sports development, I help kids aged 4-14 build fundamental movement skills, coordination, and a love for sports. Safe, fun and age-appropriate training.',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 64,
    bio: 'Certified Hatha and Vinyasa yoga instructor from India with 8 years of experience. I offer personalized yoga sessions focusing on flexibility, mindfulness, and stress reduction. Sessions available indoors or on the beach.',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 156,
    bio: 'Ex-professional footballer (UAE Pro League) turned dedicated youth coach. I teach football fundamentals, tactical awareness, and teamwork. Sessions for all skill levels – from beginners to aspiring professionals.',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 98,
    bio: 'Black belt in Taekwondo and Brazilian Jiu-Jitsu instructor. I teach self-defense, discipline, and confidence to both children and adults. Training is conducted in a safe, respectful environment with focus on character development.',
